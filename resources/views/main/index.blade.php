                    ...
                    <div class="card-body">
                        <div class="table-responsive table-card">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div>
                                                        <img src="/static/images/svg/brand-logo-1.svg"
                                            ...
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar bootstrap 5"
                                                        src="/static/images/avatar/avatar-11.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="bootstrap 5 avatar"
                                                        src="/static/images/avatar/avatar-2.jpg" class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="bootstrap 5 avatar in circle"
                                                        src="/static/images/avatar/avatar-3.jpg" class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                                    <span class="avatar-initials rounded-cifs-6">+5</span>
                                                </span>
                                            </div>
                                        </td>
                                        <td class=" text-dark">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div>
                                                        <img src="/static/images/svg/brand-logo-2.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-4.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-5.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-6.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div>
                                                        <img src="/static/images/svg/brand-logo-3.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-7.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-8.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-9.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div>
                                                        <img src="/static/images/svg/brand-logo-6.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                                    <h5 class=" mb-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-10.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-11.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-12.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                                    <span class="avatar-initials rounded-circle
                            ...
                            align-items-center">
                                                <div>
                                                    <div>
                                                        <img src="/static/images/svg/brand-logo-4.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-13.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-14.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm">
                                                    <img alt="avatar" src="/static/images/avatar/avatar-15.jpg"
                                                        class="rounded-circle">
                                                </span>
                                                <span class="avatar avatar-sm avatar-primary">
                                                    <span class="avatar-initials rounded-circle
                            ...
                            align-items-center">
                                                <div>
                                                    <div>
                                                        <img src="/static/images/svg/brand-logo-5.svg" alt="Image">
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                    ...
                    <div class="card-header d-flex align-items-center
                        ...
                        <div class="dropdown dropstart">
                            <a class="btn btn-icon btn-ghost btn-sm rounded-circle" href="#!" role="button"
                                id="dropdownTask" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <a href="#!"><img src="/static/images/avatar/avatar-2.jpg"
                                                            alt="Image" class="avatar-md avatar rounded-circle"></a>
                                                </div>
                                                <div class="ms-3 lh-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <a href="#!"> <img src="/static/images/avatar/avatar-11.jpg"
                                                            alt="Image" class="avatar-md avatar rounded-circle"></a>
                                                </div>
                                                <div class="ms-3 lh-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <a href="#!"><img src="/static/images/avatar/avatar-3.jpg"
                                                            alt="Image" class="avatar-md avatar rounded-circle"></a>
                                                </div>
                                                <div class="ms-3 lh-1">
                                                    <h5 class=" mb-1"> <a href="#!" class="text-inherit">Sandeep
                                                            Chauhan</a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <a href="#!"> <img src="/static/images/avatar/avatar-4.jpg"
                                                            alt="Image" class="avatar-md avatar rounded-circle"></a>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <a href="#!"> <img src="/static/images/avatar/avatar-5.jpg"
                                                            alt="Image" class="avatar-md avatar rounded-circle"></a>
                                                </div>

                                                <div class="ms-3 lh-1">
                                                    <h5 class=" mb-1"> <a href="#!" class="text-inherit">Patricia
                                                            Murrill</a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <a href="#!"><img src="/static/images/avatar/avatar-6.jpg"
                                                            alt="Image" class="avatar-md avatar rounded-circle"></a>
                                                </div>
                                                <div class="ms-3 lh-1">
                                                    <h5 class=" mb-1"> <a href="#!" class="text-inherit">Darshini
                                                            Nair</a></h5>
...
@section('scripts')
<script src="{{ asset('static/libs/apexcharts/dist/apexcharts.min.js') }}"></script>
<script src="{{ asset('static/js/vendors/chart.js') }}"></script>
@endsection