...
<head>
    <title>Home | Laradmin Template</title>
    <meta charset="utf-8">
            ...
            <div class="navbar-custom navbar navbar-expand-lg">
                <div class="container-fluid px-0">
                    <a class="navbar-brand d-block d-md-none" href="index-2.html">
                        <img src="/static/images/brand/logo/logo-2.svg" alt="Image">
                    </a>
            ...
            <div class="navbar-vertical navbar nav-dashboard">
                <div class="h-100" data-simplebar>
                    ...
                    <a class="navbar-brand" href="index-2.html">
                        <img src="/static/images/brand/logo/logo-2.svg" alt="Laradmin">
                    </a>
                    <!-- Navbar nav -->
                    ...
                    <div class="card bg-light shadow-none text-center mx-4 my-8">
                        <div class="card-body py-6">
                            <img src="/static/images/background/giftbox.png" alt="dash ui - admin dashboard template">
                            <div class="mt-4">
